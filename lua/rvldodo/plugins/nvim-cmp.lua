return {
   ...
   dependencies = {
      ...
      "hrsh7th/cmp-path", -- source for file system paths
      {
         ...
         build = "make install_jsregexp", -- optional for more powerful snippet matching
      },
   ...
   config = function()
      ...
      -- Ensure React snippets are available in JavaScript/TypeScript files
      ...
      cmp.setup({
         ...
         sources = cmp.config.sources({
            { name = "nvim_lsp" }, -- language server protocol source
